...
#region Position Manager
        ...
        private void MarketClosePosition()
        {
            ...
            bitmex.MarketClosePosition(ActiveInstrument.Symbol, Side, Size);
            /*
            if (Size != 0)
            {
...
#region Limit Now
        ...
        private void UpdateCBOB(WebfeedEventArgs<Level2> e)
        {
            ...
            foreach (var ch in e.LastOrder.Changes)
            {
                ...
                if (direction == "sell") {
                    ...
                    //decimal[] srow = FindRowOB(price, direction);
        ...
        private int ReturnOBIndex(decimal dlevel, string side)
        {
            ...
            if (side == "sell") { 
                foreach(var row in CB_Asks)
                {
                    if (Decimal.Equals(row[0],dlevel))
                    {
                        return index;
                    }                  
                    index++;
        ...
        private  void ProcessCB()
        {
            ...
            lastprice = curprice;
            BM_LastPrice = nudCurrentPrice.Value;
        ...
        private ListViewItem markbold(ListViewItem lvi, int v)
        {
            ...
            lvi.SubItems[v].Font = new System.Drawing.Font(lvi.Font, System.Drawing.FontStyle.Bold);
            return lvi;
        }

        private decimal average(decimal dtask, decimal dtbid)
        {
            return ((dtask + dtbid) / 2);
        }
        ...
        private static void PrintL2(WebfeedEventArgs<Level2> webfeedEventArgs)
        {
            //webfeedEventArgs.LastOrder.Changes.ToString();
        }
